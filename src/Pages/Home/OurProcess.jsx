    ...
    const items = [
        {
            ...
            text: "Other companies wanted to charge for a new windshield just to fix a leak. These guys are top notch and explain exactly what they will do to fix your problem without over charging. And I thank you for the fast response too.",
            icon: icons.speed,
        ...
        {
            title: "Get Result",
            text: "To test the validity of instruments, procedures, or experiments, research may replicate elements of prior projects or the project as a whole.",
            icon: icons.security,
        ...
        <>
            ...
            <div style={styles.wrapper}>
                ...
                <div style={styles.grid}>
                    {items.map((i, index) => (
                        <div key={index} className="zoom-card" style={styles.card}>
